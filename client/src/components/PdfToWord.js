...
const PdfToWord = () => {
  ...
  const handleDrop = (acceptedFiles) => {
    ...
    if (!uploadedFile.name.endsWith('.pdf')) {
      setError('Invalid file type. Must be PDF.');
      return;
    }
  ...
  return (
    <div className="bg-white p-6 rounded-lg shadow-md">
      <h2 className="text-xl font-semibold mb-1">📄 PDF to Word</h2>
      <p className="text-gray-400 text-sm mb-4">Upload a PDF, get a .docx file</p>
